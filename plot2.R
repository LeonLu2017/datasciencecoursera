...
## 4. The plot will output to plot2.png file with a width of 480 pixels and a height of 480 pixels. The Y lable is "Global Active Power (kilowatts)"
##------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------##
# Start main program
...
# Generate plot on global_active_power
